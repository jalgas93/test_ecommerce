...
import uz.shop.feature_home.databinding.ViewholderRecommendedBinding
import uz.shop.feature_home.domain.navigation.NavigationList

class PopularAdapter(val items: MutableList<ItemsModel>, val navigation: NavigationList) :
    ...
    override fun onBindViewHolder(holder: PopularAdapter.ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            navigation.openDetail(items[position])
        }
